...
public class PersistenceImpl implements Persistence {
    ...
    private static final Logger L = LogManager.getLogger(PersistenceImpl.class);
    ...
    public PersistenceImpl(
            File dataDirectory,
            Supplier<Config> supplierDefaultConfig,
            Supplier<Collection<XZone>> supplierDefaultZones)
